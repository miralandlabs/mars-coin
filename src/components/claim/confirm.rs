...
use crate::{
    ...
    hooks::{use_gateway, use_mars_balance, use_priority_fee, use_proof, use_pubkey, PriorityFee},
};
...
pub fn ClaimConfirm(amount: u64, claim_step: Signal<ClaimStep>) -> Element {
    ...
    let mut balance = use_mars_balance();
            ...
            div {
                ...
                div {
                    ...
                    p {
                        ...
                        "{amount_to_ui_amount(amount, mars::TOKEN_DECIMALS)}"
                    }
                }
            }
            div {
